...
def invenadd():
    ...
    if product_id == "" or name == "" or stock_level == "" or incoming_stock == "" or outgoing_stock == "" or cost == "":
...
def addinven():
    ...
    headingLabel = tk.Label(headingFrame1, text="Add New Inventory", font='Helvetica 14 bold', bg="#d7a26c", fg='black')
    ...
    songInfo1.bind("<KeyRelease>", validate_product_id)

    lb2 = Label(labelFrame, text="Product Name:", font='Helvetica 13 bold', bg="#d7a26c", fg='black')
    ...
    lb3 = Label(labelFrame, text="Stock Level:", font='Helvetica 13 bold', bg="#d7a26c", fg='black')
    ...
    lb4 = Label(labelFrame, text="Incoming Stock:", font='Helvetica 13 bold', bg="#d7a26c", fg='black')
    ...
    lb5 = Label(labelFrame, text="Outgoing Stock:", font='Helvetica 13 bold', bg="#d7a26c", fg='black')
    ...
    SubmitBtn = Button(root, text="Submit", font='Helvetica 12 bold', bg='#d7a26c', fg='black', command=invenadd)
